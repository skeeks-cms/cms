...
activitySurfaceExpect(strpos($listView, "'emptyText'    => false") !== false, 'Empty CMS activity still renders redundant placeholder content.');
activitySurfaceExpect(strpos($listView, 'Записей нет') === false, 'Empty CMS activity still renders the legacy no-records card.');
