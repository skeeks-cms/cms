 ...
 */
class ControlToolbar extends \skeeks\cms\base\Component implements BootstrapInterface
{
    /**
    ...
    public function renderToolbar($event)
    {
        ...
        echo '<div id="sx-control-toolbar" data-url="' . $url . '" style="display:none"></div>';
        /* @var $view View */
        $view = $event->sender;
