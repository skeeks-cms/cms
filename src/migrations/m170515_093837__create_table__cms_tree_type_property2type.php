...
class m170515_093837__create_table__cms_tree_type_property2type extends Migration
{
    public function safeUp()
    {
        ...
        $this->createIndex('cms_tree_type_property_id', '{{%cms_tree_type_property2type}}',
            'cms_tree_type_property_id');
        $this->createIndex('cms_tree_type_id', '{{%cms_tree_type_property2type}}', 'cms_tree_type_id');

        $this->createIndex('property2content', '{{%cms_tree_type_property2type}}',
            ['cms_tree_type_property_id', 'cms_tree_type_id'], true);
