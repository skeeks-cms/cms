...
class m250313_132302__create_table__cms_user_schedule extends Migration
{
    public function safeUp()
    {
        $tableName = 'cms_user_schedule';
        ...
        $this->createTable($tableName, [
            ...
            'end_at' => $this->integer()->null()->comment("Завершение работы"),
        ...
        $this->addCommentOnTable($tableName, 'Рабочее время сотрудника');
