...
class m170512_023840__alter_table__cms_content_element_property extends Migration
{
    public function safeUp()
    {
        ...
        $this->createIndex("property2element2value_enum", "{{%cms_content_element_property}}",
            ["property_id", "element_id", "value_enum"]);
        $this->createIndex("property2element2value_num", "{{%cms_content_element_property}}",
            ["property_id", "element_id", "value_num"]);
    }
