...
class m170701_133344__alter_table__cms_tree_property extends Migration
{
    public function safeUp()
    {
        ...
        $this->addForeignKey(
            'cms_tree_property__created_by', "{{%cms_tree_property}}",
            'created_by', '{{%cms_user}}', 'id', 'SET NULL', 'SET NULL'
        );
        $this->addForeignKey(
            'cms_tree_property__updated_by', "{{%cms_tree_property}}",
