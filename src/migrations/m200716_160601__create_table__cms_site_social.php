...
class m200716_160601__create_table__cms_site_social extends Migration
{
    public function safeUp()
    {
        $tableName = 'cms_site_social';
        ...
        $this->createTable($tableName, [
            ...
            'social_type' => $this->string(255)->notNull(),
        ...
        $this->createIndex($tableName.'__social_type', $tableName, 'social_type');
        $this->createIndex($tableName.'__url_uniq', $tableName, ['cms_site_id', 'url'], true);

        $this->addCommentOnTable($tableName, 'Социальные сети сайта');
