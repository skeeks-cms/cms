...
class m200309_153000__update_data__cms_content_element_property extends Migration
{
    public function safeUp()
    {
        ...
        SET 
            p.`value_element_id` = p.value_enum 
        WHERE 
	...
	")->execute();
        ...
        /*$subQuery = $this->db->createCommand("SELECT
                ...
                where 
                    cms_content_property.property_type = 'E'")->queryAll();
