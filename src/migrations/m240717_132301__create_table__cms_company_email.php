...
class m240717_132301__create_table__cms_company_email extends Migration
{
    public function safeUp()
    {
        $tableName = 'cms_company_email';
        ...
        $this->createTable($tableName, [
            ...
            'value' => $this->string(255)->notNull()->comment("Email"),
        ...
        $this->addCommentOnTable($tableName, 'Email-ы компаний');
