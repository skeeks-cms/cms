...
class m220705_110601__create_table__cms_callcheck_provider extends Migration
{
    public function safeUp()
    {
        $tableName = 'cms_callcheck_provider';
        ...
        $this->addCommentOnTable($tableName, 'Авторизация по звонку провайдеры');
