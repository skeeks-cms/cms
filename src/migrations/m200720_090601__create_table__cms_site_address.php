...
class m200720_090601__create_table__cms_site_address extends Migration
{
    public function safeUp()
    {
        $tableName = 'cms_site_address';
        ...
        $this->createTable($tableName, [
            ...
            'work_time' => $this->text()->comment("Рабочее время"),
        ...
        $this->addCommentOnTable($tableName, 'Адреса сайта');
