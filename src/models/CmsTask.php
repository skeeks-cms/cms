...
class CmsTask extends ActiveRecord
{
    ...
    static public function statusesFeatureHints($status = null)
    {
        $data = [
            ...
            self::STATUS_IN_WORK  => "Начать работу по этой задаче. <br />Если рабочее время выключено, система включит его автоматически. У вас не должно быть запущено других задач.",
