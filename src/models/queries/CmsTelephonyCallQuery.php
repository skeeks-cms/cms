 ...
 * @author Semenov Alexander <semenov@skeeks.com>
 */
class CmsTelephonyCallQuery extends CmsActiveQuery
{
    ...
    public function executor($user)
    {
        ...
        $this->andWhere(['cms_worker_user_id' => $user_id]);
        return $this;
    }

    /**
     * @param $status
     * @return CmsTelephonyCallQuery
     */
    ...
    {
        return $this->status(CmsTelephonyCall::STATUS_NEW);
    }
    /**
     * @return CmsTelephonyCallQuery
     */
    public function statusConversation()
    {
        return $this->status(CmsTelephonyCall::STATUS_CONVERSATION);
    }
    /**
     * @return CmsTelephonyCallQuery
     */
    public function statusRinging()
    {
        return $this->status(CmsTelephonyCall::STATUS_RINGING);
    }
    /**
     * @return CmsTelephonyCallQuery
     */
    ...
    {
        return $this->status(CmsTelephonyCall::STATUS_ANSWERED);
    }
    /**
     * @return CmsTelephonyCallQuery
     */
    ...
    {
        return $this->status(CmsTelephonyCall::STATUS_FAILED);
    }
