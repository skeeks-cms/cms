...
/**
 * Class UserPropertyYandexMap
 * @package skeeks\cms\relatedProperties\userPropertyTypes
 */
class UserPropertyYandexMap extends PropertyType
{
    ...
    public function getConfigFormFile()
    {
        ...
        return dirname($class->getFileName()) . DIRECTORY_SEPARATOR . 'views/_formUserPropertyYandexMap.php';
    }
}