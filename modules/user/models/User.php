...
use skeeks\cms\behaviors\Implode;
use skeeks\cms\modules\subscribe\behaviors\HasSubscribes;
use skeeks\cms\modules\subscribe\behaviors\traits\HasSubscribes as THasSubscribes;
    ...
    implements IdentityInterface
{
    ...
    public function behaviors()
    {
        return [
            ...
            [
                "class"  => \skeeks\cms\behaviors\Implode::className(),
                "fields" =>  [
                    "users_subscribers",
